    ...
    <>
      ...
      <div className="min-h-screen bg-gray-50">
        ...
        <header
          ...
          style={{ backgroundImage: "url('/images/blog/business-email-english.webp')" }}
        >
          ...
          <div className="relative container mx-auto max-w-4xl">
            ...
            <p className="text-lg md:text-xl text-gray-200 max-w-3xl mx-auto">
              Master professional email writing in English with ready-to-use templates for every workplace situation.
            </p>
            <p className="mt-4 text-sm text-gray-300">By Ibrahim K. · December 20, 2024 · 9 min read</p>
          </div>
        </header>
        {/* Content */}
              ...
              <div className="mt-12 p-6 bg-slate-50 rounded-lg">
                <div className="flex items-start gap-4">
                  <img loading="lazy" 
                    ...
                    alt="Mr. Ibrahim K. — Business English coach in Tangier Morocco, expert in professional email writing" 
