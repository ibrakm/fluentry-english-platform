      ...
      >
        ...
        <div className="relative container mx-auto max-w-4xl">
          ...
          <h1 className="text-4xl md:text-5xl font-extrabold mb-4 tracking-tight leading-tight">
            How to Pass IELTS in Morocco: The Ultimate 2026 Guide
          </h1>
          <p className="text-lg md:text-xl text-gray-200 max-w-3xl mx-auto">
            Find test centers, fees, dates, and expert strategies for all four IELTS sections.
          </p>
          <p className="mt-4 text-sm text-gray-300">By Ibrahim K. · February 23, 2026 · 15 min read</p>
        </div>
      </header>
