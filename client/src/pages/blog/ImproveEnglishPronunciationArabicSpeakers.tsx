...
import { ArrowLeft, Clock, Calendar, Volume2 } from "lucide-react";
        ...
        >
          ...
          <div className="relative container mx-auto max-w-4xl">
            ...
            <p className="text-lg md:text-xl text-gray-200 max-w-3xl mx-auto">
              Master the hardest English sounds for Arabic speakers with practical exercises and expert tips.
            </p>
