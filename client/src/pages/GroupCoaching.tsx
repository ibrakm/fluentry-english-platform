...
const programmes = [
  {
    ...
    schedule: "Saturdays & Sundays, 10:00–11:30",
    price: "250",
    priceNote: "per student / per session",
    totalPrice: "3,000 MAD total",
  ...
  },
  {
    ...
    schedule: "Tuesdays & Thursdays, 19:00–20:30",
    price: "220",
    priceNote: "per student / per session",
    totalPrice: "1,760 MAD total",
      ...
      <section className="bg-white border-b border-gray-100 py-10 px-4">
        <div className="max-w-5xl mx-auto grid grid-cols-2 md:grid-cols-4 gap-6">
          {[
            ...
            { icon: TrendingUp, value: "200 MAD", label: "starting price" },
